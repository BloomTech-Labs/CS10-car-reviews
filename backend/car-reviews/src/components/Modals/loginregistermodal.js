          ...
          >
            <ModalHeader style={styles.headerStyles}>
              <Button
                ...
                color="danger"
                onClick={this.props.handleModalState('login', false)}
              >
                X
              </Button>
              <p>Login</p>
            ...
            <ModalFooter style={styles.footerStyles}>
              ...
              <p
                onClick={() => this.props.handleChangeModalType('register')}
                style={styles.footerLinkStyles}
              >
                Click here
              </p>
            </ModalFooter>
        ...
        <Modal style={styles.modalStyles} isOpen={true} toggle={this.props.toggleModal}>
          <ModalHeader style={styles.headerStyles}>
            <Button
              style={styles.closeButtonStyles}
              color="danger"
              onClick={this.props.handleModalState('register', false)}
            >
              X
            </Button>
            <p>Register</p>
          ...
          <ModalFooter style={styles.footerStyles}>
            ...
            <p
              onClick={() => this.props.handleChangeModalType('login')}
              style={styles.footerLinkStyles}
            >
              Click here
            </p>
