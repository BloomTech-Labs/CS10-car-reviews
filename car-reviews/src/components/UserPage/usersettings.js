...
class UserSettings extends Component {
  ...
  handleSubmitPassword = event => {
    ...
    axios
      .put(deployedRequests, { password }, config)
      .then(res => {
        console.log(res);
        if (this.state.alerts.password) this.handleAlerts('password');
  ...
  handleSubmitUsername = event => {
    ...
    axios
      .put(deployedRequests, { username }, config)
      .then(res => {
        console.log(res);
        if (this.state.alerts.username) this.handleAlerts('username');
  ...
  handleSubmitEmail = event => {
    ...
    axios
      .put(deployedRequests, { newEmail: email }, config)
      .then(res => {
        console.log(res);
        if (this.state.alerts.email) this.handleAlerts('email');
          ...
          <Row className="mt-3">
            <Col md="12" lg="12" sm="12">
              ...
              <Col md="12" lg={{ size: 6, offset: 3 }} sm="12" className="mt-1">
                  ...
                  <Card style={styles.cardStyles} className="mb-3">
                    <CardBody>
                      ...
                      <form onSubmit={this.handleSubmitPassword}>
                        ...
                        <Alert isOpen={this.state.alerts.passwordSuccess} color="primary">
                ...
                <Button
                  color="primary"
                  onClick={() => this.toggle('usernameCollapse')}
                  className="accordion-button mt-1"
                  style={{ marginBottom: '1rem' }}
                >
              ...
              <Col md="12" lg={{ size: 6, offset: 3 }} sm="12" className="mt-1">
                ...
                <Button
                  color="primary"
                  onClick={() => this.toggle('emailCollapse')}
                  className="accordion-button mt-1"
                  style={{ marginBottom: '1rem' }}
                >
